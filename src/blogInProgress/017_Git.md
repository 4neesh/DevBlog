...
Git stores snapshots of the source code and allows code to be branched for updates.
Rather than making updates directly to the code itself, you can make a copy to be played with and then merge it when all the unit tests are passing.

Git stores your repository in a remote location on the internet. You can interact with the repository by connecting your local machine to the remote repository.
